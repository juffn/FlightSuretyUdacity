...
contract FlightSuretyApp {
    ...
    */
    ...
    {
        require(
            flightSuretyData.isOperational(), "Contract is currently not operational"
            );  
...
// region ORACLE MANAGEMENT
    ...
    function submitOracleResponse(
        ...
        // Ensure that the oracle index matches the request index
        require(
        ...
        // Get the key for the oracle response
        bytes32 key = keccak256(abi.encodePacked(index, airline, flight, timestamp)); 
